...
namespace ElevenElevenGame
{
	...
	public class ShallowInputModule : StandaloneInputModule
	{

		static ShallowInputModule m_instance;
		public static ShallowInputModule instance {
