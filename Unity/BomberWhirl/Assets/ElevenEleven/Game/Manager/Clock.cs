...
namespace ElevenEleven
{
	...
	public class WaitForBeat : CustomYieldInstruction {
		...
		public override bool keepWaiting { 
			get {
				bool toReturn = m_keepWaiting;

                if (!waitUntil.HasValue) {
                    waitUntil = Clock.Instance.AtNext(beatValue);                
                } else {
					m_keepWaiting = Clock.Instance.TrueTime < waitUntil.Value;
                }
	...
	public class Clock : Singleton<Clock>
	{
        ...
        public double TrueTime {
            get {
                return AudioSettings.dspTime + StartDelay;
            }
        }
		...
		public int ThirtySecondCount {
			get { return _thirtySecondCount; }
		}
		...
		private double _nextMeasure = System.Double.MaxValue;
		private double _nextSixteenth = System.Double.MaxValue;
		private double _nextEighth = System.Double.MaxValue;
		private double _nextQuarter = System.Double.MaxValue;
		private double _nextHalf = System.Double.MaxValue;
