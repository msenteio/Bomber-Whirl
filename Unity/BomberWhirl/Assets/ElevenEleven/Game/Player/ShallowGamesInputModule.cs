...
//	[AddComponentMenu( "Event/InControl Input Module" )]
	public class ShallowGamesInputModule : StandaloneInputModule
	{

		static ShallowGamesInputModule m_instance;
		public static ShallowGamesInputModule instance {
...
return true;
		...
		void Update()
		{
			for (int i = 0; i < Devices.Count; i++) {
				...
				if (i == 0 || device.Direction.Value != Vector2.zero) {
